# Generated by Django 6.0.6 on 2026-09-16 22:28
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('taxPrice', models.DecimalField(blank=True, decimal_places=2, default=0.0, max_digits=10, null=True)),
                ('shippingPrice', models.DecimalField(blank=True, decimal_places=2, default=0.0, max_digits=10, null=True)),
                ...
                ('stripeSessionId', models.CharField(blank=True, max_length=255, null=True)),
